...
var fblink = 'http://facebook.com/sharer/sharer.php';
    fblink += '?u=' + encodeURIComponent(url);


var twlink = 'http://twitter.com/intent/tweet/';
    twlink += '?text=' + encodeURIComponent(text);
    twlink += '&url=' + encodeURIComponent(url);


var lilink = 'http://www.linkedin.com/shareArticle';
    lilink += '?mini=true&';
    lilink += '&url=' + encodeURIComponent(url);
    lilink += '&title=' + encodeURIComponent(title);

var gplink = 'http://plus.google.com/share';
    gplink += '?url=' + encodeURIComponent(url);
    
var social = '<div class="social">';
        social += '<a href="'+fblink+'" class="facebook" target="_blank" rel="external nofollow" onclick="return popup(this)">';
            social += fbsvg;
        social += '</a>';
        social += '<a href="'+twlink+'" class="twitter" target="_blank" rel="external nofollow" onclick="return popup(this)">';
            social += twsvg;
        social += '</a>';
        social += '<a href="'+lilink+'" class="linkedin" target="_blank" rel="external nofollow" onclick="return popup(this)">';
            social += lisvg;
        social += '</a>';
    social += '</div>';
